<template>
    <div>
        ...
        <van-form @submit="onSubmit">
            <!-- 头像 -->
            <van-field v-model="toxiang" name="头像" label="头像" placeholder="头像" @click="showPopup" />
            <van-popup v-model="show" position="bottom" :style="{ height: '25%' }" class="photo">
                <p>拍照</p>
                <van-divider />
                <p>从手机相册选择</p>
                <van-divider />
            ...
            <van-popup v-model="showPickers" position="bottom">
                <van-datetime-picker v-model="currentDate" type="date" title="选择年月日" :min-date="minDate"
                    :max-date="maxDate" @confirm="onConfirms" @cancel="showPickers = false" />
            </van-popup>
            ...
            <van-popup v-model="showPicker_subject" position="bottom">
                <van-picker show-toolbar :columns="columns_subject" @confirm="onConfirm_subject"
    ...
    export default {
        ...
        methods: {
            ...
            onConfirms(date) {
                ...
                let s = date.getTime() //获取选择时间的时间戳
                let time = dtime(s).format( //用插件里面的dtime中的format方法把时间戳转化为"YYYY-MM-DD"格式 就是年月日
                    "YYYY-MM-DD"
                );
                this.values = time //赋值给你的表单
